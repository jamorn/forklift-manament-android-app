...
class AuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun mockLogin(email: String): Result<UserProfile> {
        ...
        val mockProfile = MOCK_USERS[email.lowercase()]
    ...
    companion object {
        ...
        val MOCK_USERS = mapOf(
            "jamorn@irpc.co.th" to UserProfile(
            ...
            "supv-pl@irpc.co.th" to UserProfile(
                ...
                companyName = "IRPC",
                status = listOf("active"),
                roles = com.irpc.forklift.core.domain.model.ForkliftRoles(
                    role = "admin",
                    scope = listOf("dept-bagging-pp12", "dept-bagging-pp3", "dept-bagging-ppe", "dept-bagging-ppc", "dept-bagging-hd", "dept-sealroom"),
                ),
                mailto = listOf("maintenance-report", "daily-plan"),
            ...
            "wiroj@abc-logistics.co.th" to UserProfile(
