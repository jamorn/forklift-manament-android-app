 ...
 */
object MockData {
    data class ChecklistItem(val id: String, val label: String, val category: String)
    ...
    val vehicles = listOf(
        Vehicle(chassis_no = "FK-001", current_flno = "FL-1201", department_id = "dept-bagging-pp12", vehicle_type = "TOYOTA 8FBN25", status = "active", is_active = true, lease_start = "2025-01-01", lease_end = "2027-12-31", rental_price = 25000, flno_history = emptyList()),
        Vehicle(chassis_no = "FK-002", current_flno = "FL-1202", department_id = "dept-bagging-pp12", vehicle_type = "TOYOTA 8FBN25", status = "active", is_active = true, lease_start = "2025-01-01", lease_end = "2027-12-31", rental_price = 25000, flno_history = emptyList()),
        Vehicle(chassis_no = "FK-003", current_flno = "FL-1203", department_id = "dept-bagging-pp3", vehicle_type = "TOYOTA 8FBN25", status = "active", is_active = true, lease_start = "2025-03-01", lease_end = "2027-12-31", rental_price = 25000, flno_history = emptyList()),
        Vehicle(chassis_no = "FK-004", current_flno = "FL-1204", department_id = "dept-bagging-ppe", vehicle_type = "Nissan HBF25", status = "maintenance", is_active = true, lease_start = "2025-06-01", lease_end = "2027-12-31", rental_price = 22000, flno_history = emptyList()),
        Vehicle(chassis_no = "FK-005", current_flno = "FL-1205", department_id = "dept-bagging-ppc", vehicle_type = "TOYOTA 8FBN25", status = "active", is_active = true, lease_start = "2025-02-01", lease_end = "2027-12-31", rental_price = 25000, flno_history = emptyList()),
        Vehicle(chassis_no = "FK-006", current_flno = "FL-1206", department_id = "dept-bagging-hd", vehicle_type = "Nissan HBF25", status = "active", is_active = true, lease_start = "2025-04-01", lease_end = "2027-12-31", rental_price = 22000, flno_history = emptyList()),
        Vehicle(chassis_no = "FK-007", current_flno = "FL-1207", department_id = "dept-sealroom", vehicle_type = "TOYOTA 8FBN25", status = "active", is_active = true, lease_start = "2025-05-01", lease_end = "2027-12-31", rental_price = 25000, flno_history = emptyList()),
        Vehicle(chassis_no = "FK-008", current_flno = "FL-1208", department_id = "dept-bagging-pp12", vehicle_type = "TOYOTA 8FBN25", status = "active", is_active = true, lease_start = "2025-07-01", lease_end = "2027-12-31", rental_price = 25000, flno_history = emptyList()),
    )
